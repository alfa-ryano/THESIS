...
%In conclusion, time and space complexity of state-based model differencing is mainly affected the size of two compared versions and the extent they are different. For change-based model differencing, its time and space complexity is mainly affected by the num 
